...
Namespace SimpleObject
    ...
    Public Class CloneHelper
        ...
        Public Function Clone(Of T)(ByVal source As T, ByVal synchronize As Boolean) As T
            Return CType(Clone(CObj(source), synchronize), T)
        End Function
        ...
        Private Sub CloneProperty(ByVal memberInfo As XPMemberInfo, ByVal source As Object, ByVal target As Object, ByVal synchronize As Boolean)
            If TypeOf memberInfo Is Metadata.Helpers.ServiceField OrElse memberInfo.IsKey Then
                Return
            End If
        ...
        Public Sub Dispose() Implements IDisposable.Dispose
            If targetSession IsNot Nothing Then targetSession.Dispose()
        End Sub
    End Class
End Namespace
